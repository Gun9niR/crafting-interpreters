...
public class Parser {
        ...
        if(!check(TokenType.RIGHT_PAREN)) {
            do {
                if(parameters.size() >= 255) {
                    error(peek(), "Cannot have more than 255 parameters in function definition.");
                }
    ...
    private Stmt expressionStatement() {
        ...
        else if(!isAtEnd()) match(TokenType.SEMICOLON);
    ...
    private Expr assignment() {
        ...
        if(match(TokenType.EQUAL)) {
            ...
            if(expr instanceof Expr.Variable) {
                ...
                return new Expr.Set(get.object, get.name, value); // stuff the value into the fields of the instance
            }
